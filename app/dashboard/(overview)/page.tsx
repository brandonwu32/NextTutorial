...
import { fetchTotalPaidInvoices, fetchTotalPendingInvoices, fetchNumberInvoices, fetchNumberCustomers } from '@/app/lib/data';
...
export default async function Page() {
    ...
    const numberOfInvoices = await fetchNumberInvoices();
    const numberOfCustomers = await fetchNumberCustomers();
